...
# OPI 3.0
 * Major rewrite of the entire package to include
 ...
 * Added QUESTP procedure from Giovanni Montesaro
 * Small 'feature' in ZEST fixed so minStimulus is presented if pdf calls for something <= minStimulus
