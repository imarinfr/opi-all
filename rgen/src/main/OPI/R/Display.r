...
#'
opiInitialise_for_Display <- function(port = NULL, ip = NULL) {
...
#' @seealso [opiSetup()]
#'
opiSetup_for_Display <- function(settings = list(eye = NULL, fixShape = NULL, fixLum = NULL, fixCx = NULL, fixSx = NULL, fixCy = NULL, fixSy = NULL, fixRotation = NULL, fixCol = NULL, bgLum = NULL, tracking = NULL, bgCol = NULL)) {
if(!exists(".opi_env") || !exists("Display", envir = .opi_env) || !("socket" %in% names(.opi_env$Display)) || is.null(.opi_env$Display$socket))
...
#' @seealso [opiPresent()]
#'
opiPresent_for_Display <- function(stim = list(phase = NULL, shape = NULL, sx = NULL, lum = NULL, sy = NULL, rotation = NULL, texRotation = NULL, length = NULL, type = NULL, defocus = NULL, frequency = NULL, eye = NULL, color1 = NULL, color2 = NULL, t = NULL, w = NULL, contrast = NULL, x = NULL, y = NULL)) {
if(!exists(".opi_env") || !exists("Display", envir = .opi_env) || !("socket" %in% names(.opi_env$Display)) || is.null(.opi_env$Display$socket))
