...
opiInitialise_for_PhoneHMD <- function(ip = NULL, port = NULL, ip_Monitor = NULL, port_Monitor = NULL) {
    assign("socket", open_socket(ip_Monitor, port_Monitor), .opi_env$PhoneHMD)
...
if(!exists(".opi_env$PhoneHMD") || !exists(".opi_env$PhoneHMD$socket") || is.null(.opi_env$PhoneHMD$socket))
...
#' @seealso [opiPresent()]
#'
opiPresent_for_PhoneHMD <- function(stim = list(eye = NULL, shape = NULL, type = NULL, x = NULL, y = NULL, sx = NULL, sy = NULL, lum = NULL, color = NULL, rotation = NULL, contrast = NULL, phase = NULL, frequency = NULL, defocus = NULL, textRotation = NULL, t = NULL, w = NULL)) {
if(!exists(".opi_env$PhoneHMD") || !exists(".opi_env$PhoneHMD$socket") || is.null(.opi_env$PhoneHMD$socket))
