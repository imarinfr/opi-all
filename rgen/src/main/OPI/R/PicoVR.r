...
opiInitialise_for_PicoVR <- function(ip = NULL, port = NULL, ip_Monitor = NULL, port_Monitor = NULL) {
    assign("socket", open_socket(ip_Monitor, port_Monitor), .opi_env$PicoVR)
...
if(!exists(".opi_env$PicoVR") || !exists(".opi_env$PicoVR$socket") || is.null(.opi_env$PicoVR$socket))
...
#' @seealso [opiPresent()]
#'
opiPresent_for_PicoVR <- function(stim = list(eye = NULL, shape = NULL, type = NULL, x = NULL, y = NULL, sx = NULL, sy = NULL, lum = NULL, color = NULL, rotation = NULL, contrast = NULL, phase = NULL, frequency = NULL, defocus = NULL, textRotation = NULL, t = NULL, w = NULL)) {
if(!exists(".opi_env$PicoVR") || !exists(".opi_env$PicoVR$socket") || is.null(.opi_env$PicoVR$socket))
