...
VERSION=1.0.0
CORE="$M2_HOME/repository/org/lei/opi/core/$VERSION/core-$VERSION.jar"
OPIJ="$M2_HOME/repository/org/lei/opi/opiJovp/$VERSION/opiJovp-$VERSION.jar"
...
CP="$CORE:
    ...
    $M2_HOME/repository/org/openjfx/javafx-swing/19/javafx-swing-19-mac-aarch64.jar:
    $M2_HOME/repository/org/openjfx/javafx-swing/19/javafx-swing-19.jar:
    $M2_HOME/repository/org/openpnp/opencv/4.9.0-0/opencv-4.9.0-0.jar:
    $M2_HOME/repository/com/diffplug/durian/durian/2.0/durian-2.0.jar:
    ...
    $M2_HOME/repository/org/lwjgl/lwjgl-freetype/3.3.3/lwjgl-freetype-3.3.3.jar:
    ...
    $M2_HOME/repository/org/joml/joml/1.10.5/joml-1.10.5.jar:
    $M2_HOME/repository/io/github/java-native/jssc/2.9.6/jssc-2.9.6.jar:
