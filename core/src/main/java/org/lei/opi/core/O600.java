...
public class O600 extends OpiMachine {
  ...
  @Parameter(name = "ip_Monitor", desc = "IP Address of the OPI O600 server.", defaultValue = "localhost")
  @Parameter(name = "port_Monitor", desc = "TCP port of the OPI O600 server.", className = Double.class, min = 0, max = 65535, defaultValue = "50001")
