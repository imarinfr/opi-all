...
public class Jovp extends OpiMachine {
    ...
    */
    ...
    @Parameter(name = "type", className = es.optocom.jovp.definitions.TextureType.class, desc = "Stimulus type. Values include FLAT, SINE, CHECKERBOARD, SQUARESINE, G1, G2, G3", isList = true, optional = true, defaultValue = "[FLAT]")
